 ...
 * Tavily Search API
 */
async function searchTavily(query: string, options: WebSearchOptions): Promise<WebSearchResult[]> {
 ...
 */
async function searchDuckDuckGo(query: string, maxResults = 5): Promise<WebSearchResult[]> {
