...
exports.parseGUIAction = parseGUIAction;
exports.formatGUIAction = formatGUIAction;
function parseGUIAction(modelOutput) {
...
function parseActionInputs(actionStr) {
    const inputs = {};
    ...
    if (directionMatch) {
        inputs.direction = directionMatch[1];
    }
...
function formatGUIAction(action) {
    const parts = [];
    switch (action.type) {
        case 'click':
        case 'left_double':
