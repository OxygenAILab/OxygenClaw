...
class ContainerManager {
     ...
     */
    async createAgentContainer(config) {
     ...
     */
    async executeGUIAction(containerId, action) {
     ...
     */
    async getGUIContext(containerId) {
        try {
            // Take screenshot
    ...
    async getStats(containerId) {
        ...
        try {
            ...
            // @ts-ignore
            const networkIO = stats.networks ? Object.values(stats.networks).reduce((acc, net) => acc + (net.rx_bytes + net.tx_bytes), 0) : 0;
